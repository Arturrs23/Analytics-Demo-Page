...
<template>
    ...
    <footer class="bg-main border-t-20 border-pink footer-main-bg relative pt-48">
  
      <svg    class="absolute -z-5 top-12 right-0" width="1005" height="1005" viewBox="0 0 1005 1005" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.07">
        <path d="M1834.54 437.483C1653.46 173.305 1349.47 -0.00012207 1005 -0.00012207C449.954 -0.00012207 0 449.953 0 1005C0 1085.75 9.52405 1164.28 27.5092 1239.52L539.295 727.732C588.354 678.672 667.896 678.672 716.955 727.732L1130.62 1141.4L1834.54 437.483Z" fill="#8794BA"/>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 inner-footer-main-bg">
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 z-10">
            
                <!-- Pricing Card -->
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 rounded-2xl  drop-shadow-2xl  shadow dark:border-gray-600 xl:p-20 bg-card-bg dark:text-white">
                    <h3 class="mb-4 text-2xl font-semibold">Starter</h3>
                    <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">up to 3 users</p>
                    <hr>
                    <div class="flex flex-col content-center justify-center items-center my-8">
                        <span class="mr-2 text-5xl font-extrabold">$29</span>
                        <span class="text-gray-500 dark:text-gray-400">/month</span>
                        
                    </div>
                    <PrimaryButton class="bg-transparent border ">Order</PrimaryButton>


                </div>
                <!-- Pricing Card -->
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 rounded-2xl drop-shadow-2xl   drop-shadow-2xl dark:border-gray-600 xl:p-20 xl:py-20 bg-white dark:text-blue-900">
                    <h3 class="mb-4 text-2xl font-semibold">Standart</h3>
                    <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">up to 20 users</p>
                    <hr>
                    <div class="flex flex-col content-center justify-center items-center my-8">
                ...
                <!-- Pricing Card -->
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 drop-shadow-2xl  rounded-2xl  shadow dark:border-gray-600 xl:p-20 bg-card-bg dark:text-white">
                    <h3 class="mb-4 text-2xl font-semibold">Premium</h3>
                    <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">up to 200 users</p>
                    <hr>
                    <div class="flex flex-col content-center justify-center items-center my-8">
            ...
            <div class="social flex justify-between lg:grid-cols-3">
                <div class="flex flex-shrink-0 items-center ml-4">
                    <a class="flex items-center" href="/"> <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <path d="M38.8854 13.4001L24.2678 28.0178C23.2915 28.9941 21.7085 28.9941 20.7322 28.0178L12.5 19.7855L2.53418 29.7514C5.9555 35.8662 12.495 40 20 40C31.0457 40 40 31.0457 40 20C40 17.6874 39.6075 15.4664 38.8854 13.4001Z" fill="#EF2A82"/>
                         ...
                         <h3 class="text-white uppercase	font-bold pl-3 text-2xl">Analytics</h3>
                       </a>
                 </div>
                ...
                <ul class="flex">
                    ...
                    <li><svg width="25" height="20" viewBox="0 0 25 20" fill="none" xmlns="http://www.w3.org/2000/svg">
